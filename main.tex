...
supernovae out to the Large or even Small Magellanic Clouds. A Galactic event 
is likely to be detectable with a network of H+L+VK if the explosion mechanism 
is the neutrino-driven mechanism.  By testing the convolutional neural network 
with waveforms not used for training, we show that the true alarm probabilities 
are $50\%$ and $73\%$ at $50$ kpc for waveforms $\text{R3E1AC}$ and 
$\text{R4E1FC\_L}$ for networks of HLVK and H+L+VK respectively.  
For waveforms $\text{s}20$ and $\text{SFHx}$ at $10$ kpc, 
the true alarm probabilities are $64\%$ for a network of H+L+VK. 
All at false alarm probability equal to $1\%$. 
\end{abstract}
...
from~\cite{abdikamalov2014measuring} for an equatorial observer. The progenitor is $12\text{M}_\odot$ with
...
core bounce. The waveforms shown in all panels are for an observer in the equatorial plane.\label{fig:magwaveforms}} 
\end{figure*}
%
...
For the left and middle panels, the observer is assumed to be along the pole, 
while an observer along the equator is assumed for the right panel.
The sources are assumed to be at $10$ kpc from earth. The x-axes show the time after core bounce.
The waveform shown in the left panel is for a polar observer, while the other panels show that 
...
roughly $l = 3.0 \times 10^{5}$ data samples, where each of the 3 classes
contains approximately $1.0\times10^{5}$ data samples.
%
...
Of the remainder, $\sim 1.7\times10^{5}$ for training and $\sim 1.2\times10^{5}$ for tesing. 
...
of $1\%$, the \ac{CNN} achieves a \ac{TAP} of $87\%$ and $72\%$ for the
networks H+L+VK and HLVK respectively. At more restrict \acp{FAP} such as
$0.01\%$, the \ac{CNN} still achieves \acp{TAP} of $75\%$ and $62\%$ for sources at
...
\ac{TAP} of $82\%$ (H+L+VK) or $60\%$ (HLVK) at a \ac{FAP} of $1\%$. Such a range
...
belokurov2007cats}.  For sources at $100$ kpc, the \acp{TAP} are no less than $50\%$ 
for H+L+VK for all chosen \acp{FAP} values, and is $61\%$ if
the \ac{FAP} is $1\%$. These numbers indicate that with
such a \ac{GW} network, it is possible to detect magnetorotational \ac{CCSN}
signals out to such a distance. For sources at $150$ and $200$ kpc, the \acp{TAP}
drop to $39\%$ and $21\%$ respectively for \ac{FAP} equal to $1\%$.
...
a \ac{TAP} of $53\%$ and $22\%$ for H+L+VK and HLVK respectively if the
\ac{FAP} is $1\%$.  This means that for a \ac{GW} from a Galactic \ac{CCSN}
signal it is possible to detect and classify it with a network of H+L+VK.
...
For H+L+VK and magnetorotational signals at $10$ kpc, the \ac{TAP} is $97\%$. If the distance
is extended to $100$ kpc, the \ac{TAP} is still larger than $50\%$. 
For HLVK, the \ac{TAP} is $95\%$ for sources at $10$ kpc and drops to $54\%$ at
$60$ kpc.
%The \acp{TAP} decrease to $10\%$ and $9\%$ for sources at $150$ and $200$ kpc.
For all distances, the \ac{CNN} maintains a \ac{FAP} no larger than $0.2\%$ for
both networks regarding magnetorotational waveforms. For neutrino-driven
signals, we show that H+L+VK has a \acp{TAP} of $39\%$ at $10$ kpc while it
is $6\%$ at $10$ kpc for HLVK with \acp{FAP} $\sim 0.1\%$. It should be noted that the results presented in this section are
...
$h_{+}$ polarisations.
The waveforms shown in the bottom panels are $\text{SFHx}$(left) and $\text{s}20$(right), for an equatorial observer,
...
%
Using the procedure described in Sec.~\ref{sec:spwf}, we generate $1.2\times10^5$
samples for each distance and therefore each class has $4\times10^4$
...
at $60$ kpc and a \ac{FAP} of $1\%$, the \ac{CNN} achieves a \ac{TAP} of $73\%$
...
For HLVK and a distance of $50$ kpc, a \ac{TAP} of $50\%$ is achieved, showing the possibility of detecting these waveforms out to the Large Magellanic Clouds.
For waveforms $\text{s}20$ and $\text{SFHx}$, the \acp{TAP} are $64\%$ and $36\%$ for the two
networks if the sources are at $10$ kpc and the \ac{FAP} is $1\%$.  The
...
was $1\%$, once trained, a \ac{CNN} could achieve a \ac{TAP} of $60\%$
for magnetorotational signals from sources at $60$ kpc. Using a network of
H+L+VK, we showed that the \ac{TAP} is increased to $82\%$.  Both the Large and
Small Magellanic Clouds are within this distance. If the distance is extended
to $150$ or $200$ kpc, a \ac{TAP} of $39\%$ or $21\%$ respectively are still
...
trained \ac{CNN}, with a \ac{FAP} of $1\%$, achieved a \ac{TAP} of $22\%$ and
$53\%$ for HLVK and H+L+VK respectively. This indicates a Galactic \ac{CCSN}
event would likely be detectable with H+L+VK.
...
$60$ kpc, the \acp{TAP} are $73\%$ and $38\%$ for H+L+VK and HLVK respectively.
For waveforms $\text{s}20$ and $\text{SFHx}$ at $10$ kpc, the \acp{TAP} are $64\%$ and
$36\%$ for the two networks respectively. All at \ac{FAP} of $1\%$. 
