...
%A Galactic event is likely to be detectable with a network of H+L+VK 
...
$\text{R4E1FC\_L}$ for networks of H+L+VK.  
For waveforms $\text{s}20$ and $\text{SFHx}$ at $10$ kpc, 
the true alarm probabilities are $49\%$ and $20\%$ for a network of H+L+VK 
and HLVK respectively. 
